			...
			if onScreen then
				...
				if not hitResult then
					...
					if char and char:FindFirstChild("Humanoid") then
						...
						if equippedTool and equippedTool.Name == "CrucifixSpecial" then
							Kill = false
							canAttack = false
							if moveConnection then moveConnection:Disconnect() end
